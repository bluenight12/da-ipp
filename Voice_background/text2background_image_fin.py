...
class TextToImageGenerator:
    ...
    def generate_image(self, steps=20, seed=20):

        f = open('bck_eng.txt')  # 생성형 이미지를 만들기 위한 txt파일 경로 입력
        text_data = f.read()
...
## main 함수에서 사용 방법
# from text2background_image_fin import *

# f = open('/home/yj/yeju/mini_project/text2image/sample.txt')  # 생성형 이미지를 만들기 위한 txt파일 경로 입력
# text_data = f.read()
# generator = TextToImageGenerator()
# generator.generate_image(text_data)