...
################################################################################
## Form generated from reading UI file 'speak_page_new.ui'
##
...
class Ui_Second_Window(object):
    def setupUi(self, Second_Window):
        ...
        self.go_forth = QPushButton(Second_Window)
        self.go_forth.setObjectName(u"go_forth")
        sizePolicy1.setHeightForWidth(self.go_forth.sizePolicy().hasHeightForWidth())
        self.go_forth.setSizePolicy(sizePolicy1)
        self.go_forth.setMaximumSize(QSize(16777215, 150))
        self.go_forth.setIconSize(QSize(16, 16))
    ...
    def retranslateUi(self, Second_Window):
        ...
        self.go_forth.setText(QCoreApplication.translate("Second_Window", u"ACCEPT", None))
