...
class Ui_Fifth_Window(object):
    def setupUi(self, Fifth_Window):
        ...
        self.finish_photo.setMaximumSize(QSize(16777215, 1000))
        self.finish_photo.setAlignment(Qt.AlignCenter)

        self.verticalLayout.addWidget(self.finish_photo)
        ...
        self.pushButton = QPushButton(Fifth_Window)
    ...
    def retranslateUi(self, Fifth_Window):
        ...
        self.pushButton.setText(QCoreApplication.translate("Fifth_Window", u"\uc81c\uc77c \ucc98\uc74c\uc73c\ub85c \ub3cc\uc544\uac00\uae30", None))
        self.label.setText("")
    # retranslateUi
